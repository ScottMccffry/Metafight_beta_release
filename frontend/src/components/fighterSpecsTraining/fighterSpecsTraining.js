        ...
        <>
            <div className="ml-1">
                ...
                <div className="w-9/10  p-2 border-4 rounded-3xl border-gray-400 mt-4">
                    ...
                    {/* Place Bid button */}
                    <button type="button" className=" mt-1 text-white bg-blue-900 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-200 dark:focus:ring-blue-900 font-medium rounded-lg text-sm px-5 py-2.5 inline-flex justify-center w-full text-center">Train</button>
                </div>
            </div>
        </>
    );
